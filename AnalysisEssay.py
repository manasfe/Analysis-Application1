...
# Display the generated reports
    st.markdown("### 3-Day Performance Report:")
    st.text(essay_3_days)

    st.markdown("### 7-Day Performance Report:")
    st.text(essay_7_days)

    st.markdown("### Performance Analysis for 3 Days:")
    st.text(performance_3_days)

    st.markdown("### Performance Analysis for 7 Days:")
    st.text(performance_7_days)

    # Add a download button for the generated reports
    st.markdown("### Download Reports")
    st.markdown("Click below to download the reports.")

    if st.button("Download 3-Day Report", key="download_3_day"):
        st.download_button(
            label="Download 3-Day Report",
            data=essay_3_days,
            file_name="3-Day_Report.txt",
            mime="text/plain"
        )

    if st.button("Download 7-Day Report", key="download_7_day"):
        st.download_button(
            label="Download 7-Day Report",
            data=essay_7_days,
            file_name="7-Day_Report.txt",
            mime="text/plain"
        )